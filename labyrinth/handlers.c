...
struct Parse_data *parse_direction(int count_args, char **command_args) {
	...
	parse_data->arg = num;
	parse_data->handler = direction;
	return parse_data;
}

int direction(struct Context *context, struct Labyrinth *lab, uintptr_t arg, int direction) {
